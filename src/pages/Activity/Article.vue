    ...
    <div>
        <el-row>
            <div class="service" v-for="(item,index) in articleList" :key="index">
                <el-col  :xl="3" :lg="2" :md="3" :sm="1" :xs="3"  class="floatLeft">&nbsp;</el-col>
                <!--<el-col :span="3" v-show="index % 2 ==0?true:false" >&nbsp;</el-col>-->
                <!--右浮占位栅格-->
                <!--<el-col :span="1" v-show="index % 2 ==0?true:false" class="floatLeft">&nbsp;</el-col>-->
                <!--左浮占位栅格-->
                <!--<el-col :xl="3" :lg="3" :md="3" :sm="0" :xs="0"  v-show="index % 2 ==1?true:false" class="floatRight">&nbsp;</el-col>-->
                ...
                <!--用空格制造间隔-->
                <el-col :xs="4" :sm="2" :md="2" :lg="2" :xl="2">&nbsp;</el-col>
                <el-col :xs="18" :sm="10" :md="9" :lg="9" :xl="8">
                    <div class="article">
